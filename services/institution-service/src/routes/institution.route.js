...
// Public tenant branding (unauthenticated, tenant-resolved)
router.get('/branding', institutionController.getInstitutionBranding);
router.get('/branding/:subdomain', institutionController.getInstitutionBranding);
